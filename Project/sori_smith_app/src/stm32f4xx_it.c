...
/* Private macro -------------------------------------------------------------*/
/* Private variables ---------------------------------------------------------*/
__IO uint8_t PauseResumeStatus = 2, Count = 0, LED_Toggle = 0,Timer_cnt0=0;
uint16_t capture = 0;
uint16_t Timer_cnt1=0;
uint8_t	IsButton_Left=0,IsButton_Right=0;
extern __IO uint16_t CCR_Val;
extern __IO uint8_t RepeatState, AudioPlayStart;
extern uint8_t Buffer[];
extern uint8_t  AUDIO_LEFT;
